...
start = int(input("Введите результат спортсмена в первый день: "))
finish = int(input("Введите необходимый результат: "))
...
print(f"Требуемого результата спортсмен достигнет за {day} дней")